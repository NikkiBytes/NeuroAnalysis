...
mean_img.to_filename('/projects/niblab/bids_projects/Experiments/ChocoData/derivatives/images/4w_partB_HF_LS_milk_mean_nimask.nii')

# Create the figure
from nilearn.plotting import plot_stat_map, show
display = plot_stat_map(weight_img, mean_img, title='SVM weights HF_LS vs h2O for 4 waves, partB')
display.savefig('/projects/niblab/bids_projects/Experiments/ChocoData/derivatives/images/4w_partB_HF_LS_milk_SVM_nimask.png')
# Saving the results as a Nifti file may also be important
weight_img.to_filename('/projects/niblab/bids_projects/Experiments/ChocoData/derivatives/images/4w_partB_HF_LS_milk_SVM_nimask.nii')
